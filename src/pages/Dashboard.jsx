    ...
    <PageWrapper>
      <div style={{ backgroundColor: "#0B0B0C" }} className="w-full min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12">
            {[
              ...
              >
                ...
                <span style={{ color: stat.color }} className="text-2xl font-bold">
                  {stat.value}
                </span>
          ...
          >
            <h2 style={{ color: "#F8FAFC" }} className="text-lg font-semibold">
              Listed Skills
            </h2>
            <Link
              to="/list-skill"
              ...
              >
                ...
                {skills.map((skill, i) => (
                  <motion.div
                    ...
                    style={{
                      borderBottom:
                        i < skills.length - 1 ? "1px solid #ffffff0a" : "none",
                    }}
                  ...
                  >
                    ...
                    <p style={{ color: "#00E5FF" }} className="text-sm font-bold">
                      ${skill.price_usdc}
                    </p>
                    <p style={{ color: "#F8FAFC" }} className="text-sm">
                      {skill.downloads.toLocaleString()}
                    </p>
                    <p style={{ color: "#00E5FF" }} className="text-sm font-medium">
              ...
              <div className="flex flex-col gap-4 sm:hidden">
                {skills.map((skill, i) => (
                  ...
                  >
                    ...
                    <div style={{ backgroundColor: "#ffffff0a" }} className="w-full h-px" />

                    <div className="grid grid-cols-3 gap-4">
                      <div className="flex flex-col gap-1">
                        <p style={{ color: "#94A3B8" }} className="text-xs">Downloads</p>
                        <p style={{ color: "#F8FAFC" }} className="text-sm font-medium">
                          {skill.downloads}
                        </p>
                      </div>
                      <div className="flex flex-col gap-1">
                        <p style={{ color: "#94A3B8" }} className="text-xs">Earnings</p>
                        <p style={{ color: "#00E5FF" }} className="text-sm font-medium">
                          ${(skill.downloads * skill.price_usdc).toFixed(2)}
                        </p>
                      </div>
                      <div className="flex flex-col gap-1">
                        <p style={{ color: "#94A3B8" }} className="text-xs">Rating</p>
