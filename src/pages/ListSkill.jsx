      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p style={{ color: "#94A3B8" }} className="text-sm sm:text-base">
            Fill in the details below. Every download pays you instantly in USDC
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            {/* Skill Name */}
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0} className="flex flex-col gap-2">
              <label style={labelStyle} className="text-xs font-medium uppercase tracking-wider">
                Skill Name *
              </label>
              <input
                type="text"
            ...
            {/* Category */}
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1} className="flex flex-col gap-2">
              <label style={labelStyle} className="text-xs font-medium uppercase tracking-wider">
                Category *
              </label>
              <select
            ...
            {/* Short Description */}
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={2} className="flex flex-col gap-2">
              <label style={labelStyle} className="text-xs font-medium uppercase tracking-wider">
                Short Description * <span style={{ color: "#94A3B8" }} className="normal-case">(shown on catalog cards)</span>
              </label>
              <input
                type="text"
            ...
            {/* Full Description */}
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={3} className="flex flex-col gap-2">
              <label style={labelStyle} className="text-xs font-medium uppercase tracking-wider">
                Full Description * <span style={{ color: "#94A3B8" }} className="normal-case">(shown on detail page)</span>
              </label>
              <textarea
            ...
            {/* Price */}
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={4} className="flex flex-col gap-2">
              <label style={labelStyle} className="text-xs font-medium uppercase tracking-wider">
                Price (USDC) *
              </label>
              <div
              ...
              >
                ...
                />
                <span
                  style={{ color: "#94A3B8", borderLeft: "1px solid #ffffff0f" }}
            ...
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={5} className="flex flex-col gap-2">
              ...
              >
                {walletAddress || "Connect your wallet to auto-fill this field"}
              </div>
            ...
            {/* File Upload */}
            <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={6} className="flex flex-col gap-2">
              <label style={labelStyle} className="text-xs font-medium uppercase tracking-wider">
                Skill File (.zip) *
              </label>
              <label
              ...
              >
                ...
                <div className="text-center">
                  ...
                  >
                    {file ? file.name : "Click to upload your skill .zip file"}
                  </p>
